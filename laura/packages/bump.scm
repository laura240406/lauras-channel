    ...
    (source
      (origin
        ...
        (uri (git-reference
              ...
              (commit "v4.0.3")))
        (file-name (git-file-name name version))
        (sha256 (base32 "0yi80d8w4l69siia5rvdzakyzkm7vbpfk6ffcwc6vm6z0i58m9cl"))))
    (build-system qt-build-system)
    (inputs (list qtsvg-5))
    (arguments (list #:build-type "Release" #:tests? #f #:phases #~(modify-phases %standard-phases (delete 'validate-runpath))))
    (home-page "https://jkriege2.github.io/JKQtPlotter/index.html")
    (synopsis "This is an extensive C++ library for data visualization, plotting and charting for Qt.")
    (description "JKQTPlotter is an extensive Qt5 & Qt6 Plotter framework (including a feature-richt plotter widget, a speed-optimized, but limited variant and a LaTeX equation renderer!), written fully in C/C++ and without external dependencies.")
    (license license:lgpl2.1)))

(define-public avogadrolibs-bumped
  (package
    (name "avogadrolibs")
    (version "1.102.0")
    (source
     (origin
       ...
       (uri (git-reference
             ...
             (commit version)))
       (sha256
        (base32 "1m2hd47p453f92myjdf6njrk8vdk8221287ap8z4mnfz5r808csp"))
       (file-name (git-file-name name version))))
    (build-system cmake-build-system)
    (native-inputs
     (list eigen
      ...
      `(("glew" ,glew)
        ...
        ("avogadro-crystals"
          ,(origin
            ...
            (sha256
              (base32
                "11pqc2ppd1lsizxs11ppaih4w3ck9qmgn92rrc4zrdwfssawa72s"))))
        ("avogadro-fragments"
          ,(origin
            (method git-fetch)
            (uri
            ...
            (sha256
              (base32
                "1g6r87g9xw6qn99hcb8i1x1444jxwfcn8m7cy3k4f075bld26pf7"))))))
    (arguments
     (list
      #:configure-flags #~(list "-DENABLE_TESTING=ON" (string-append "-DJKQTPlotterSharedLib_DIR=" #$jkqtplotter "/lib/cmake"))
      #:phases
      #~(modify-phases %standard-phases
          (add-after 'unpack 'patch
            (lambda _
              (substitute* "avogadro/qtgui/CMakeLists.txt" (("JKQTPlotter\\$\\{QT_VERSION\\}") "JKQTPlotterSharedLib"))
              (substitute* "avogadro/qtgui/CMakeLists.txt" (("JKQTPlotterSharedLib::JKQTPlotterSharedLib") "JKQTPlotterSharedLib"))))
...
(define-public avogadro2-bumped
  (package
    (name "avogadro2")
    (version "1.102.0")
    (source
     (origin
       ...
       (uri (git-reference
             ...
             (commit version)))
       (sha256
        (base32 "1iknps1pd46vn9vpnwvimwwh5i43zwf1l1hs9x6rvi4w9adydgjl"))
       (file-name (git-file-name name version))))
    (build-system cmake-build-system)
    (native-inputs
      `(("eigen" ,eigen)
        ...
        ("avogadro-i18n"
         ,(origin
           ...
           (sha256
             (base32
               "1krw3xaplwriznwbfyspni0rf3pjmwi6mylqhp10nhnxd9vgs3lb"))))))
    (inputs (list avogadrolibs-bumped hdf5 molequeue openbabel qtbase-5 qtsvg-5))
